...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
		...
		BL_DEC,		BL_INC,	 KC_TRNS,			KC_TRNS, KC_TRNS, KC_TRNS,	TO(1),
    ...
    [2] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, KC_BTN1, KC_MS_U,	KC_BTN2, KC_WH_U, KC_TRNS,	TO(2),
     ...
     * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │     │     │     │XXXXX│     │     │     │     │
     * │ TRN │ TRN │ TRN │-NOK-│ TRN │ TRN │ TRN │ TRN │
     * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │     │     │UNDO │COPY │REDO │     │     │     │
     * │ TRN │ TRN │CTR-Z│CTR-C│CTR-Y│ TRN │ TRN │ TRN │
     * └─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
	 *       │     │<-HL │PASTE│ HL->│     │     │ TO  │
     *       │ TRN │SHF-L│CTR-V│SHF-R│ TRN │ TRN │ L(3)│
     *       ├─────┼─────┴─────┴─────┼─────┼─────┼─────┤
     *       │     │                 │     │     │     │
     *       │ TRN │                 │ TRN │ TRN │ TRN │	 
     *       ├─────┤                 ├─────┼─────┼─────┘
    ...
    [3] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, LCTL(KC_Z), 	 LCTL(KC_C), LCTL(KC_Y), 	KC_TRNS, KC_TRNS,	KC_TRNS,
				 KC_TRNS, LSFT(KC_LEFT), LCTL(KC_V), LSFT(KC_RGHT),	KC_TRNS, KC_TRNS,	TO(3),
				 KC_TRNS,											KC_TRNS, KC_TRNS,	KC_TRNS,
				 KC_TRNS,											KC_TRNS, KC_TRNS
	)
    /* Layer 4
     ...
     * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │     │     │     │     │     │ PAGE│     │ TO  │
     * │ TRN │ TRN │COPY │ UP  │PASTE│ UP  │ TRN │ L(4)│
     * └─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
	 *       │     │     │     │     │ PAGE│     │     │
    ...
    [4] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, KC_COPY, KC_UP,	KC_PSTE, KC_PGUP, KC_TRNS,TO(4),
				 KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_TRNS,KC_TRNS,
