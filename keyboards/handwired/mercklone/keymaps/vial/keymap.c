...
void keyboard_post_init_user(void) {
    vial_tap_dance_entry_t td1 = { KC_F1,
                                  MO(1),
                                  TO(1),
                                  KC_NO,
                                  TAPPING_TERM };
								  
	vial_tap_dance_entry_t td2 = { KC_F2,
                                  MO(2),
                                  TO(2),
                                  KC_NO,
                                  TAPPING_TERM };
								  
	vial_tap_dance_entry_t td3 = { KC_F3,
                                  MO(3),
                                  TO(3),
                                  KC_NO,
                                  TAPPING_TERM };
								  
	dynamic_keymap_set_tap_dance(F1_L1, &td1); // the first value corresponds to the TD(i) slot
	dynamic_keymap_set_tap_dance(F2_L2, &td2);
	dynamic_keymap_set_tap_dance(F3_L3, &td3);
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_default(
		...
		/*---*/		KC_TRNS, /*---*/  /*---*/	/*---*/  KC_TRNS, KC_TRNS,	QK_BOOTLOADER,
    ...
    [3] = LAYOUT_default(
		...
		/*---*/	 KC_TRNS, /*---*/	/*---*/		/*---*/		LCTL(KC_X),	KC_TRNS,	QK_REBOOT,
		/*---*/	 KC_TRNS, /*---*/	/*---*/		/*---*/		KC_TRNS,	KC_TRNS
	),
    /* Layer 4
	 * NOK = NO PHYSICAL KEY IN MATRIX
